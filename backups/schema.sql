...
DROP ROLE pgbouncer;
DROP ROLE pgsodium_keyholder;
DROP ROLE pgsodium_keyiduser;
DROP ROLE pgsodium_keymaker;
DROP ROLE postgres;
...
ALTER ROLE authenticator WITH NOSUPERUSER NOINHERIT NOCREATEROLE NOCREATEDB LOGIN NOREPLICATION NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:EXxoFsk7LLnof3SV4rZmyg==$14EIEFt5AVHkQV9ZUKvRNK8sfUredAWcnu8yIUMivsQ=:g94d6C7tEZ3k1E9hDxawBhyNxlR/eiIv0w9rPS57nBs=';
CREATE ROLE dashboard_user;
ALTER ROLE dashboard_user WITH NOSUPERUSER INHERIT CREATEROLE CREATEDB NOLOGIN REPLICATION NOBYPASSRLS;
CREATE ROLE pgbouncer;
ALTER ROLE pgbouncer WITH NOSUPERUSER INHERIT NOCREATEROLE NOCREATEDB LOGIN NOREPLICATION NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:MJs7ELw/5N7HQJUZvtaTgg==$s1u0BdEk0NZU5d+atCrWFekkpNOT/gCIuLv7MGLQNQw=:KhXRnJqUCDY12ft3OW3N9Cnni9v7U3xXMJDJCYl3YvY=';
...
ALTER ROLE postgres WITH NOSUPERUSER INHERIT CREATEROLE CREATEDB LOGIN REPLICATION BYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:WE6kG6mFfWIFwpoZNtsLCQ==$DlRwSiOBPSXMtH0xcdQMjiddgfxjbmpTBYiesCEYkvA=:5SGAij7Qywy53bw2vDU/zP/Qyt7Vq1iI5I4a1Yd8H54=';
CREATE ROLE service_role;
ALTER ROLE service_role WITH NOSUPERUSER INHERIT NOCREATEROLE NOCREATEDB NOLOGIN NOREPLICATION BYPASSRLS;
CREATE ROLE supabase_admin;
ALTER ROLE supabase_admin WITH SUPERUSER INHERIT CREATEROLE CREATEDB LOGIN REPLICATION BYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:2mn77lF4CUi0bbXCTTWgDA==$nise5FcneAX9pzdzHYu+p2Le0dUr97G3QZLJVl9WD7Q=:zHxb88i05NgkbQpwsEkNv2w+E91oAKPOgTGuSBjcK48=';
...
ALTER ROLE supabase_storage_admin WITH NOSUPERUSER NOINHERIT CREATEROLE NOCREATEDB LOGIN NOREPLICATION NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:BlOb/3+pBC1zpl3pG3Hs/Q==$jOLRxTQgcmyiI3MVIRKBCXIteB7bzgFwrQ26zD78Hak=:iCAWrpUrdAHrEDcoPKxKGyQSvk58R50lJxAVEYZJEmc=';
...
ALTER DATABASE postgres SET "app.settings.jwt_secret" TO 'Yk2580x/uGP164Pb37cZAyVi1GWt98Pxh4OWSHOh/Zlv116YKu7slD7HZpN9CMyYR7X2Zqg5U2K+0Lm0PcmCyQ==';
...
--
-- Name: dislike_quiz(uuid, bigint); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.dislike_quiz(voter_id uuid, quiz_id bigint) RETURNS void
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
BEGIN
...
--
-- Name: like_quiz(uuid, bigint); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.like_quiz(voter_id uuid, quiz_id bigint) RETURNS void
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
BEGIN
...
--
-- Name: right_password(character varying); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.right_password(password character varying) RETURNS boolean
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
...
--
-- Name: session_exists(uuid); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: COLUMN quizzes.data; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.quizzes.data IS 'stores the questions and answers of the quiz';


--
-- Name: COLUMN quizzes.owner; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.quizzes.owner IS 'who owns this quiz';


--
-- Name: COLUMN quizzes.title; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.quizzes.title IS 'the title of the quiz';


--
-- Name: COLUMN quizzes.description; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.quizzes.description IS 'the description of the quiz';


--
-- Name: COLUMN quizzes.visibility; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.quizzes.visibility IS 'is the quiz public, unlisted, or private';


--
-- Name: COLUMN quizzes.bg; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.quizzes.bg IS 'the url of the background image';
...
--
-- Name: quizzes quizzes_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: quizzes quizzes_owner_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: quizzes Enable read access for all users; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: profiles Enable update for users based on user_id; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: quizzes delete quiz; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: SCHEMA graphql_public; Type: ACL; Schema: -; Owner: -
--
...
--
-- Name: FUNCTION dislike_quiz(voter_id uuid, quiz_id bigint); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION like_quiz(voter_id uuid, quiz_id bigint); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION right_password(password character varying); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION session_exists(session_id uuid); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: SEQUENCE quizzes_id_seq; Type: ACL; Schema: public; Owner: -
--
